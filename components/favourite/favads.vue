          ...
          <div class="col-lg-9 col-md-12 col-12">
            <div class="main-content">
              <div class="dashboard-block mt-0">
                ...
                <nav class="list-nav">
                  <ul>
                    <li class="active"><a href="javascript:void(0)">Featured Ads <span>42</span></a></li>
                  </ul>
                </nav>
                ...
                <div class="my-items">
                  ...
                  <div class="single-item-list">
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-3 col-md-3 col-12 align-right">
                        <ul class="action-btn">
                          <li><a href="javascript:void(0)"><i class="fa-solid fa-pen-to-square"></i></a></li>
                          <li><a href="javascript:void(0)"><i class="fa-solid fa-eye"></i></a></li>
                          <li><a href="javascript:void(0)"><i class="fa-solid fa-trash"></i></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
