              ...
              <div class="row">
                <div class="col-lg-3 col-md-4 col-12">
                  <div class="single-item-grid">
                    <div class="image">
                      <a href=""><img src="~assets/images/items-tab/item-1.jpg" alt="#"></a>
                    ...
                    <div class="content">
                      ...
                      <p class="location"><a href="javascript:void(0)"><i class="fas fa-map-marker"></i>
                        Boston</a>
                      </p>
                      <ul class="info">
                        <li class="price">$890.00</li>
                        <li class="like"><a href="javascript:void(0)"><i class="fas fa-heart"></i></a>
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div class="content">
                      ...
                      <p class="location">
                        <a href="javascript:void(0)">
                          <i class="fas fa-map-marker"></i>Delaware, USA
                          </a>
                      </p>
                      <ul class="info">
                        <li class="price">$299.00</li>
